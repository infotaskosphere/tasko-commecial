// ClientDiscussion.jsx — meeting capture and approval-gated follow-up workspace.
//
// The assistant is deliberately local-first: the browser records audio and
// speech-to-text when supported, then prepares editable suggestions in memory.
// Nothing is persisted or scheduled until the user explicitly approves it.

import React, { useCallback, useEffect, useMemo, useRef, useState } from 'react';
import {
  Archive, AudioLines, CalendarClock, Check, CheckCircle2, Download, FileText,
  ListChecks, Loader2, MessageSquareText, Mic, Pause, Pencil, Play, Plus,
  RotateCcw, Search, Sparkles, Square, Trash2, Users, X,
} from 'lucide-react';
