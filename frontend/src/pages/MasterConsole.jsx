...
export default function MasterConsole() {
  ...
  // Module purchase and page selection are independent. Enabling a module
  // creates an empty feature selection; the administrator must explicitly
  // choose the pages that belong to that module.
