          ...
          <div className="p-4 space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <input type="file" multiple accept=".pdf,.xlsx,.xlsm,.xls,.csv"
                ...
                className={`min-w-0 flex-1 text-xs ${muted} file:mr-3 file:px-3 file:py-1.5 file:border file:border-slate-300 file:bg-slate-50 file:text-slate-700 file:font-semibold file:cursor-pointer`} />
